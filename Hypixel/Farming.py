## Refer to readme.txt before usage
"""
Auto Farm Movement Script for Minescript
Automatically moves back and forth in a farm pattern with randomization
"""
...
CONFIG = {
    ...
    "enable_sprint": True,  # Whether to enable sprinting or not
}
